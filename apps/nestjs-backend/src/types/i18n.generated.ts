    ...
    "common": {
        ...
        "automation": {
            ...
            "page": {
                ...
                "sidebarTitle": string;
                "createWithAi": string;
                "createInactiveDraft": string;
                "createRecordTrigger": string;
                "optionalTableId": string;
                "onCreate": string;
                "onUpdate": string;
                "onMatchConditions": string;
                "aiSummarizeOnCreate": string;
                "recordTriggerHint": string;
                "createEmailTrigger": string;
                "createEmailDraft": string;
                "createEmailHint": string;
                "createFormTrigger": string;
                "createFormDraft": string;
                "createFormHint": string;
                "createScheduleTrigger": string;
                "createScheduleDraft": string;
                "createScheduleHint": string;
                "createWebhookTrigger": string;
                "createWebhookDraft": string;
                "createWebhookHint": string;
                "noWorkflows": string;
                "workflowDetail": string;
                "workflowDetailDescription": string;
                "applyUpdate": string;
                "testRun": string;
                "activate": string;
                "deactivate": string;
                "nodeDebugState": string;
                "editScript": string;
                "editPrompt": string;
                "editRecordUpdate": string;
                "editRecordCreate": string;
                "editRecordQuery": string;
                "editGenericAction": string;
                "latestSelectedNodeRun": string;
                "webhookEndpoint": string;
                "triggerWebhook": string;
                "optionalWebhookSecret": string;
                "optionalWebhookSignatureSecret": string;
                "webhookBodyLimitKb": string;
                "webhookTimestampToleranceSeconds": string;
                "fieldMappingsJson": string;
                "activationTestInputJson": string;
                "activationChecksJson": string;
                "webhookSigningContract": string;
                "webhookHint": string;
                ...
                "triggerEmailReceive": string;
                "emailReceivedHint": string;
                "formSubmittedTrigger": string;
                "triggerFormSubmit": string;
                "formSubmittedHint": string;
                "testRunInput": string;
                "testRunInputHint": string;
                "workflowMetadata": string;
                "defaultDraftPrompt": string;
                "saveMetadata": string;
                "selectOrCreateDraft": string;
                "runHistory": string;
                "noRuns": string;
                "runDetail": string;
                "steps": string;
                ...
                "next": string;
                "addRunScript": string;
                "addAiGenerate": string;
                "addRecordUpdate": string;
                "addRecordCreate": string;
                "addRecordQuery": string;
                "addSendEmail": string;
                "addHttpRequest": string;
                "addCondition": string;
                "addLoop": string;
                "recordTriggerScope": string;
                "noRecordTriggerConfigured": string;
                "whenRecordCreated": string;
                "whenRecordUpdated": string;
                "whenRecordMatchesConditions": string;
                "optionalFilterJsonExample": string;
                "recordTriggerScopeHint": string;
                "runScriptDraft": string;
                "saveScript": string;
                "noRunScriptConfigured": string;
                "recordActionConfig": string;
                ...
                "take": string;
                "filterJson": string;
                "noRecordActionSelected": string;
                "structuredFieldsHint": string;
                "genericActionConfig": string;
                "saveGenericAction": string;
                "noGenericActionSelected": string;
                "aiGeneratePromptDraft": string;
                "savePrompt": string;
                "noAiGenerateConfigured": string;
                "applyUpdateDisabledReason": string;
                "actionNotRunnable": string;
                "nodeType": {
                    "trigger": string;
                    "action": string;
                };
                "nodeKind": {
                    ...
                    "recordMatchesConditions": string;
                    "webhook": string;
                    "schedule": string;
                ...
                "defaultName": {
                    "aiRecordSummary": string;
                    "whenWebhookCalled": string;
                    "whenEmailReceived": string;
                    "whenFormSubmitted": string;
                    "onSchedule": string;
                };
                "defaultDescription": {
                    "recordTriggerDraft": string;
                    "webhookDraft": string;
                    "emailDraft": string;
                    "formDraft": string;
            ...
            "toast": {
                ...
                "applied": string;
                "deleted": string;
                "testRunInputMustBeObject": string;
                "testRunInputInvalidJson": string;
                "testRunFinished": string;
                "nodeTestInputMustBeObject": string;
                "nodeTestInputInvalidJson": string;
                "nodeTestFinished": string;
                "webhookInputMustBeObject": string;
                "webhookInputInvalidJson": string;
                "webhookRunFinished": string;
                "emailInputMustBeObject": string;
                "emailInputInvalidJson": string;
                "emailRunFinished": string;
                "scheduleInputMustBeObject": string;
                "scheduleInputInvalidJson": string;
                "scheduleRunFinished": string;
                "formInputMustBeObject": string;
                "formInputInvalidJson": string;
                "formRunFinished": string;
                "metadataSaved": string;
                "scriptSaved": string;
                "aiPromptSaved": string;
                "recordActionConfigInvalidJson": string;
                "recordActionSaved": string;
                "genericActionConfigInvalidJson": string;
                "genericActionSaved": string;
                "scheduleIntervalPositive": string;
                "scheduleCronRequired": string;
                "triggerConfigInvalidJson": string;
                "recordTriggerSaved": string;
                "actionAdded": string;
        ...
        "system": {
            ...
            "publishedApp": {
                ...
                "resourceUnavailableTitle": string;
                "resourceUnavailableDescription": string;
                "readOnly": string;
                "interactive": string;
                "copyEnabled": string;
                "saveEnabled": string;
                "mobileHint": string;
                "publishedAppTitle": string;
                "publishedAppDescription": string;
                "publishedDashboardTitle": string;
                "publishedDashboardDescription": string;
                "dashboardReadonlyGuidance": string;
                "dashboardInteractiveGuidance": string;
                "dashboardMobileGuidance": string;
                "dashboardDesktopGuidance": string;
                "publishedViewTitle": string;
                "publishedViewDescription": string;
                "tableMobileGuidance": string;
                "tableDesktopGuidance": string;
                "tableAllowEdit": string;
                "tableReadonly": string;
                "tableAllowCopy": string;
                "tableDenyCopy": string;
                "tableAllowSave": string;

...
| 当前状态 | 主线绿灯，CI 待确认 |
| 当前红灯 | 无本地主线红灯 |
| 当前失败层 | CI workflow 待确认 |
| 当前已证实 | create/update persistence、repository 回读、duplicate/import、普通数据复制与 junction 复制主线链路已通过 focused e2e |
...
| related CI workflow | 待确认 | 需要触发并记录相关 GitHub Actions workflow 结果 |

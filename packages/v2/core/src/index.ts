...
export * from './commands/UpdateViewNameCommand';
export * from './commands/UpdateViewNameHandler';
...
export * from './queries/GetViewByIdQuery';
export * from './queries/GetViewByIdHandler';
...
export * from './domain/table/specs/TableUpdateViewNameSpec';
export * from './domain/table/specs/TableUpdateViewOptionsSpec';
export * from './domain/table/specs/TableUpdateViewPropertiesSpec';
